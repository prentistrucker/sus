...
// #pragma directive is a special purpose directive and is used to turn on or off some features.
// These types of directives are compiler-specific i.e., they vary from compiler to compiler
//'#pragma omp critical' specifies that code is  executed by only one thread at a time i.e., only one thread enters
